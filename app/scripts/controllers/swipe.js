...
angular.module('swipe4goodApp')
    .controller('SwipeCtrl', ['$scope', '$http', '$geolocation','$mdToast', function($scope, $http, $geolocation, $mdToast) {
        ...
        function init() {
            ...
            $scope.issues = [];
            $scope.issues[0] = { type: 0, src: "images/type1.svg", label: "Action 1", description: "Generic Issue"};
            $scope.issues[1] = { type: 1, src: "images/type2.svg", label: "Action 2", description: "Ramp"};
            $scope.issues[2] = { type: 2, src: "images/type3.svg", label: "Action 3", description: "Narrow Pass"};
            $scope.issues[3] = { type: 3, src: "images/type4.svg", label: "Action 4", description: "Semaphore Sound"};
